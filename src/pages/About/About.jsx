...
const About = () => {
  ...
  const subheadings = [
    { label: 'DEVOPIA', content: "Devopia is an exciting 24-hour offline hackathon that offers open innovation in both the hardware and software domains. Participants can enjoy free food, comfortable accommodations, and engaging games throughout the event. Plus, there are cool swags to take home as well!" },
    ...
    { label: 'BID-BY-BIT', content: "Bid-by-Bit is a pre-event to Devopia and it introduces a unique concept of auctioning in the Competitive Programming arena. Contestants bid on problem statements to decide which ones they get to solve!" }
  ];
